...
seasonResultsOrignal <- seasonResults
...
seasonResultsCompiled <- bind_rows(seasonResults[,c(1,3)],seasonResults[,c(1,5)])
...
seasonResultsCompiledUnique$WinsAtHome <- NA
seasonResultsCompiledUnique$WinsAtAway <- NA
seasonResultsCompiledUnique$WinsAtNeutral <- NA
seasonResultsCompiledUnique$LosesAtHome <- NA
seasonResultsCompiledUnique$LosesAtAway <- NA
seasonResultsCompiledUnique$LosesAtNeutral <- NA
```
...
for (i in 1:NROW(seasonResultsCompiledUnique)){
    ...
    seasonResultsCompiledUnique[i,3] <- nrow(seasonResultsOrignal %>%
                                               filter(Season == seasonResultsCompiledUnique[i,1], WTeamID == seasonResultsCompiledUnique[i,2]))
    
    seasonResultsCompiledUnique[i,4] <- nrow(seasonResultsOrignal %>%
                                              filter(Season == seasonResultsCompiledUnique[i,1], LTeamID == seasonResultsCompiledUnique[i,2]))
    
    #HOME
    seasonResultsCompiledUnique[i,5] <- nrow(seasonResultsOrignal %>%
                                               filter(Season == seasonResultsCompiledUnique[i,1], WTeamID == seasonResultsCompiledUnique[i,2], WLoc == "H"))
    
    #Away
    seasonResultsCompiledUnique[i,6] <- nrow(seasonResultsOrignal %>%
                                              filter(Season == seasonResultsCompiledUnique[i,1], WTeamID == seasonResultsCompiledUnique[i,2], WLoc == "A"))
    
    #Neutral
    seasonResultsCompiledUnique[i,7] <- nrow(seasonResultsOrignal %>%
                                               filter(Season == seasonResultsCompiledUnique[i,1], WTeamID == seasonResultsCompiledUnique[i,2], WLoc == "N"))
    
     #HOME
    seasonResultsCompiledUnique[i,8] <- nrow(seasonResultsOrignal %>%
                                               filter(Season == seasonResultsCompiledUnique[i,1], LTeamID == seasonResultsCompiledUnique[i,2], WLoc == "H"))
    
    #Away
    seasonResultsCompiledUnique[i,9] <- nrow(seasonResultsOrignal %>%
                                              filter(Season == seasonResultsCompiledUnique[i,1], LTeamID == seasonResultsCompiledUnique[i,2], WLoc == "A"))
    
    #Neutral
    seasonResultsCompiledUnique[i,10] <- nrow(seasonResultsOrignal %>%
                                               filter(Season == seasonResultsCompiledUnique[i,1], LTeamID == seasonResultsCompiledUnique[i,2], WLoc == "N"))
}
```
...
```{r}
#write to file
write.csv(seasonResultsCompiledUnique, file = "allteams-allseason-winloss.csv", row.names = FALSE)
```
...
```{r}
#combine WTeam and LTeam stats
seasonResultsCompiled <- bind_rows(Events2010[,c(2,4:5,8:9)],Events2011[,c(2,4:5,8:9)],Events2012[,c(2,4:5,8:9)],Events2013[,c(2,4:5,8:9)],Events2014[,c(2,4:5,8:9)],Events2015[,c(2,4:5,8:9)],Events2016[,c(2,4:5,8:9)],Events2017[,c(2,4:5,8:9)])
head(seasonResultsCompiled)
#find all unique values by BOTH Season and TeamID
#this will be the skeleton of the final database we want
